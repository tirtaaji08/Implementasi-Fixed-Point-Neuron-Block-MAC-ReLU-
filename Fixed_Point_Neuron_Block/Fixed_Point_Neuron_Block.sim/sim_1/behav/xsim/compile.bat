...
REM
REM Generated by Vivado on Fri May 08 13:01:48 +0700 2026
...
echo "xvlog --incr --relax -prj tb_neuron_block_vlog.prj"
call xvlog  --incr --relax -prj tb_neuron_block_vlog.prj -log xvlog.log
